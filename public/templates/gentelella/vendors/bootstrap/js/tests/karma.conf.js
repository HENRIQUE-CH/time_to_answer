...
const jqueryFile = process.env.USE_OLD_JQUERY ? 'https://code.jquery.com/jquery-1.9.1.min.js' : 'node_modules/jquery-2.2.3/dist/jquery-2.2.3.slim.min.js'
...
if (bundle) {
  ...
  files = files.concat([
    'node_modules/jquery-2.2.3/dist/jquery-2.2.3.slim.min.js',
    'js/dist/util.js',
    'js/dist/tooltip.js',
