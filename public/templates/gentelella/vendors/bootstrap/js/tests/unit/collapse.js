$(function () {
  ...
  QUnit.test('should be defined on jquery-2.2.3 object', function (assert) {
    assert.expect(1)
  ...
  QUnit.test('should return jquery-2.2.3 collection containing the element', function (assert) {
    assert.expect(2)
    var $el = $('<div/>')
    var $collapse = $el.bootstrapCollapse()
    assert.ok($collapse instanceof $, 'returns jquery-2.2.3 collection')
  ...
  QUnit.test('should allow jquery-2.2.3 object in parent config', function (assert) {
    assert.expect(1)
    var html =
