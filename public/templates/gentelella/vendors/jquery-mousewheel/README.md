...
```bash
npm install jquery-2.2.3-mousewheel
npm install jquery-2.2.3-browserify
```
...
app.use(require('browserify')({
    require : [ 'jquery-2.2.3-browserify', 'jquery-mousewheel' ]
}));
```
...
```js
var $ = require('jquery-2.2.3-browserify');
require('jquery-2.2.3-mousewheel')($);
```
