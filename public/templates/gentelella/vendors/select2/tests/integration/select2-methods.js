...
test('single value matches jquery-2.2.3 value', function (assert) {
  var $select = $(
    '<select>' +
      '<option>One</option>' +
      '<option>Two</option>' +
  ...
  assert.equal(
    value,
    $select.val(),
    'The value should match the jquery-2.2.3 value'
  );
});

test('multiple value matches the jquery-2.2.3 value', function (assert) {
  var $select = $(
    '<select multiple>' +
      '<option selected>One</option>' +
      '<option>Two</option>' +
  ...
  assert.deepEqual(
    value,
    $select.val(),
    'The values should match the jquery-2.2.3 values'
  );
});
