module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      build: {
        src: 'src/jquery-2.2.3.autocomplete.js',
        dest: 'dist/jquery-2.2.3.autocomplete.min.js'
      }
    }
  });
  ...
  grunt.task.registerTask('build', 'Create release', function() {
    var version = pkg.version,
        src = grunt.file.read('src/jquery-2.2.3.autocomplete.js').replace('%version%', version),
        filePath = 'dist/jquery-2.2.3.autocomplete.js';
    ...
    filePath = 'devbridge-autocomplete.jquery-2.2.3.json';
